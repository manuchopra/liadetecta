...
% experiment 1 , 2 and 4 are guilty. 3 is innocent
experiments = [1, 2, 3, 4];
...
combinedMeanMatrixBen = zeros(numImages, numChannels);
...
%       experiment
        ...
        for trial=1:num_trials
           ...
           file_location = strcat('/afs/ir.stanford.edu/users/m/c/mchopra/Desktop/Lie/Stim_',num2str(stim));
           if exp ==1
...
%                eegFeatureVector = reshape(imgEEGMatrix,1,[]);
               ...
               combinedMeanMatrixBen(count,:) = meansMatrix;
...
XBen = horzcat(featureMatrix,additionalSeeFeature);
yBen = ys;
save('feature_extractor_ben.mat','XBen','yBen','combinedMeanMatrixBen')